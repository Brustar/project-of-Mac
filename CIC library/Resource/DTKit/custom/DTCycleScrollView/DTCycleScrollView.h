 ...
 *  @author DT
 *
 *  @brief  scrollView已经停止滚动时调用
 *
 *  @param scrollView 当前类
 *  @param view 当前视图View
 */
- (void)scrollView:(DTCycleScrollView*)scrollView didEndDecelerating:(UIView *)view;

- (void)scrollView:(DTCycleScrollView*)scrollView didEndSelect:(UIView *)view;
