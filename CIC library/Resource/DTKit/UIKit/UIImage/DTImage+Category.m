 ...
 *  @return UIImage
 */
+ (UIImage *)drawLineByImageView:(UIImageView *)imageView cgColor:(CGColorRef)cgColor
{
    ...
    // 设置颜色
    CGContextSetStrokeColorWithColor(line, cgColor == nil ? [UIColor colorWithWhite:0.408 alpha:1.000].CGColor : cgColor);
 ...
 *  @return UIImage
 */
+ (UIImage *)drawSLineByImageView:(UIImageView *)imageView
{
    UIGraphicsBeginImageContext(imageView.frame.size); //开始画线 划线的frame
    [imageView.image drawInRect:CGRectMake(0, 0, imageView.frame.size.width, imageView.frame.size.height)];
    //设置线条终点形状
